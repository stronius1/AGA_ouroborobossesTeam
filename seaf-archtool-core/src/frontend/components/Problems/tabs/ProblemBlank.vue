...
<template>
  <v-card class="card-item">
    ...
    <template v-else>
      <v-card-title>
        <v-icon v-if="problem.exception" start style="color:#FF6F00" title="На отклонение определено исключение">mdi-alert</v-icon>
        <v-icon v-else start style="color:#f00">mdi-alert-circle</v-icon>
