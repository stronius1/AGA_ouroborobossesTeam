...
docs:
  ...
  archtol.templates:         # Пример генерации документа по шаблону
...
docs:
  ...
  archtool.templates.pml: # Пример генерации PlantUML документа по шаблону
    type: PlantUML
    source: >
      (
        {
    ...
    subjects:
      - archtool.front
      - archtool.front.spa
      - archtool.front.spa.blank
      - archtool.front.spa.blank.doc
...
Результат:
![PlantUML по шаблону](@document/archtool.templates.pml)
...
docs:
  ...
  archtool.templates.asyncapi: # Пример генерации AsyncAPI документа по шаблону
    type: AsyncAPI
    source: >
      (
...
Результат:
![AsyncAPI по шаблону](@document/archtool.templates.asyncapi)
...
docs:
  ...
  archtool.templates.openapi: # Пример генерации OpenAPI документа по шаблону
    type: OpenAPI
    source: >
      (
...
Результат:
![OpenAPI по шаблону](@document/archtool.templates.openapi)
