...
export interface AiAgent {
  ...
  fillNewChat?(systemPrompt: string, sessionSerializable: SessionSerializable): Promise<void>;
  handleMessage(message: string, session: SessionSerializable, request?: RequestWithBenefits): AsyncIterable<ContentChunk>;
  endChat(session: SessionSerializable): Promise<void>;
}
