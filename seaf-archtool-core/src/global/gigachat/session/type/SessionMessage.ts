...
export type LangchainSessionMessage =
  | AIMessage
  | HumanMessage
  | ToolMessage
  | SystemMessage;

export type GigaChatSessionMessage = Message;

export type SessionMessage = GigaChatSessionMessage | LangchainSessionMessage;
