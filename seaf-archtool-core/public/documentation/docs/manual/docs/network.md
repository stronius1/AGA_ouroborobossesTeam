...
Данными для пострения сети являются константные данные в поле source, [источник данных](/docs/archtool.datasets) или результат запроса JSONata.
...
![Документ](@document/archtool.example.network)
