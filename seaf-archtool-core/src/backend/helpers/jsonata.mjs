...
import { jsonataPerformanceLogger, jsonataLogger } from '../utils/logger/index.mjs';

export default Object.assign(
    {},
    JSONataDriver,
    { logger: jsonataLogger, performanceLogger: jsonataPerformanceLogger },
    { makeJSONataQueryResponse }
);
