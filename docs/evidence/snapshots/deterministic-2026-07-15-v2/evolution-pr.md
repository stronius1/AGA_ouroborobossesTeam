...
**Предлагаемая ветка (не создана dry-run publisher):** `skill/evolution-2026-07-16-PRIN-002` · **Дата:** 2026-07-16 · **Мутация:** `add_exception` → PRIN-002
...
-#   source_ref    — проверяемый versioned file + JSON Pointer
...
-    source_ref: "aga-skill/rules/principles.yaml#/rules/2"
-    exceptions: []
-    provenance: {origin: seed, added_in: 1.0.0}
-    status: active
+    '
...
-    check_type: llm
-    source_ref: "aga-skill/rules/principles.yaml#/rules/6"
-    exceptions: []
-    provenance: {origin: seed, added_in: 1.0.0}
-    status: active
+    '
...
-    source_ref: "aga-skill/rules/principles.yaml#/rules/7"
-    exceptions: []
-    provenance: {origin: seed, added_in: 1.0.0}
-    status: active
+    '
